...
public class KOSConsole : KOSApp {
	...
	private static KOSConsole self;
	...
	public sealed class Message {
		...
		public static Dictionary<LogType, Color> typeColors = new Dictionary<LogType, Color>() {
			{ LogType.Warning, new Color(1f, 0.5f, 0f, 0.5f) },
			{ LogType.Error, new Color(1f, 0f, 0f, 0.5f) },
			{ LogType.Exception, new Color(0.5f, 0f, 0f, 0.5f) },
			{ LogType.Log, new Color(0f, 0.8f, 1f, 0.5f) },
			{ LogType.Assert, new Color(0.6f, 0.2f, 0f, 0.5f) }
		};
